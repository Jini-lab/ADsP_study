...
## 암묵지와 형식지
- 암묵지 : 학습과 경험을 통해 개인에게 체화되어 있ㅣ만 겉으로 드러나지 않는 지식
 (특징) 다른 사람에게 공유하기 어려움
 (상호작용) 공통화, 내면화
...
|변화되는 데이터 </br> Changable Data |삽입, 수정, 삭제를 통해 항상 퇴신의 정확한 데이터를 유지해야 한다.
...
|정보 관리 측면 |- 정보를 일정한 질서와 구조에 따라 정리•저장하고 검색•관리할 수 있게 하여 방대한 양의 정보를 체계적으로 출적하고, 새로운 내용 추가나 갱신이 용이 |
...
#### 사전처리 ➡️ <span style="color:yellowgreen">사</span>전처리
